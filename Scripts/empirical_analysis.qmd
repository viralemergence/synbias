...
```{r interaction accumulation curve}
bootstrap_detect |> 
  ggplot(aes(x = downsample_size)) +
  geom_point(aes(y = facilitative_pairs_estimate), color = "#EF7C12FF", alpha = 0.7) +
  geom_point(aes(y = competitive_pairs_estimate), color = "#007BC3FF", alpha = 0.7) +
