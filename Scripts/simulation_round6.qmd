...
ggsave(here("Figures/Fig 1 input distribution v1.png"))
```
...
save_plot(here("Figures/Fig 2 GAM results v1.png"), last_plot(),
...
save_plot(here("Figures/Fig 4 Time interactions v1.png"), last_plot(), 
