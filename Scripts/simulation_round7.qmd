...
for i in 1:n_sims
    ...
    for i in 1:n_strains
        strains[i] = SEIRModel(
            ...
            rand(Truncated(Poisson(input_df.latency[i]), 1, 10))
        )
    end
...
for i in 1:n_sims
    ...
    for i in 1:n_strains
        strains[i] = SEIRModel(
            input_df.transmission[i],
            input_df.disease_mortality[i],
            input_df.recovery[i],
            round(Int, input_df.latency[i])
        )
    end
    # Initialize population - everyone starts susceptible
    initial_pop = Population(Individual[])
    ...
    mean_epidemic_duration[i] = mean(epidemic_duration)
end
...
for i in 1:n_sims
    ...
    mean_epidemic_duration_si[i] = mean(epidemic_duration)
end
