...
epidemic_duration_seir = @chain CSV.read("Data/simulation_round7_input.csv", DataFrame) begin
    @mutate(sim = 1:10000)
...
epidemic_duration_si = @chain CSV.read("Data/simulation_round7_input.csv", DataFrame) begin
    @mutate(sim = 1:10000)
    @left_join(interaction_scores, sim)
end
